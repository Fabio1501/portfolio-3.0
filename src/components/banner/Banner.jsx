...
import BtnTranslation from "../nav/BtnTranslation";
  ...
  return (
    <div className="flex flex-col justify-between items-center gap-y-8 w-full px-8 lg:px-24 py-8 md:flex-row text-white m-auto max-w-[1280px] ">
      ...
      <div className="flex flex-col items-center gap-y-4">
        <span className="">{t("banner.title")}</span>
        <CountDown></CountDown>
      </div>
      <div className="flex flex-col items-start xl:items-center justify-between xl:gap-y-4">
