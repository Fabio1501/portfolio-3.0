      ...
      <div className="max-w-[1280px] px-8 py-6 m-auto lg:py-12 lg:px-24 flex flex-col lg:flex-row items-center justify-center lg:gap-x-32 min-h-screen h-full">
        <div className="flex flex-col lg:w-1/2 gap-y-12">
          <div className="text-white font-semibold flex flex-col">
            <span ref={gsapCarrer} className="text-sm text-green-300 mb-4 md:text-xl font-normal">Full Stack Developer</span>
            <h1 ref={gsapTitle} className="xl:text-4xl text-xl md:text-5xl">Desarrollando soluciones <b className="font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-green-400 to-green-600">inteligentes,</b> construyendo relaciones <b className="font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-green-400 to-green-600">cercanas</b></h1>
          ...
          <div ref={gsapButtons} className="self-start flex items-center justify-between gap-x-12 lg:justify-center lg:gap-x-8">
            <div className="flex gap-x-4 items-center w-1/2">
              <button onClick={handleAboutUs} className="rounded-full bg-green-700 hover:bg-green-600">
            ...
            <a href="https://www.docdroid.net/mrppxoe/fabian-carabajal-full-stack-developer-pdf" target="_blank" className="flex justify-between items-center gap-x-4 text-center text-lg px-3 py-2 w-1/2 hover:bg-green-600 rounded-3xl text-white font-semibold md:text-2xl md:px-8 md:py-3 bg-green-700">
              <span>Curriculum</span>
              <BsArrowUpRight className="text-2xl font-bold"></BsArrowUpRight>
            </a>
          </div>
        </div>
